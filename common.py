...
class SEUnit(torch.nn.Module):   ###########################重点
    def __init__(self,
                 channels,
                 squeeze_factor=16,
        ...
        self.conv1 = conv1x1(in_channels=channels, out_channels=squeeze_channels, bias=True)##降维
        self.activation1 = get_activation(squeeze_activation)
        self.conv2 = conv1x1(in_channels=squeeze_channels, out_channels=channels, bias=True)   #再升维
